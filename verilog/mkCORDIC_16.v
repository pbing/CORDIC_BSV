...
//
// On Sun Nov 14 11:33:41 CET 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkCORDIC_16(CLK,
  ...
  // inlined wires
  wire [62 : 0] m_stg_0_rv$port0__write_1,
  ...
  assign m_stg_19_rv$port1__read =
	     EN_response_get ? m_stg_0_rv$port0__write_1 : m_stg_19_rv ;
  ...
  begin
	...
	m_stg_18_rv <= `BSV_ASSIGNMENT_DELAY
	    { 1'd0,
	      62'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  };
	m_stg_19_rv <= `BSV_ASSIGNMENT_DELAY
	    { 1'd0,
	      62'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  };
