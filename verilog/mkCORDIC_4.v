...
//
// On Tue Nov  9 19:33:43 CET 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkCORDIC_4(CLK,
  ...
  // inlined wires
  wire [20 : 0] m_stg_0_rv$port1__read,
  ...
  assign m_stg_0_rv$port1__read =
	     m_stg_0_rv$EN_port0__write ? 21'd699050 : m_stg_0_rv ;
  ...
  assign m_stg_1_rv$port1__read =
	     m_stg_1_rv$EN_port0__write ? 21'd699050 : m_stg_1_rv ;
  ...
  assign m_stg_2_rv$port1__read =
	     m_stg_2_rv$EN_port0__write ? 21'd699050 : m_stg_2_rv ;
  ...
  assign m_stg_3_rv$port1__read =
	     m_stg_3_rv$EN_port0__write ? 21'd699050 : m_stg_3_rv ;
  ...
  assign m_stg_4_rv$port1__read =
	     m_stg_4_rv$EN_port0__write ? 21'd699050 : m_stg_4_rv ;
  ...
  assign m_stg_5_rv$port1__read =
	     m_stg_5_rv$EN_port0__write ? 21'd699050 : m_stg_5_rv ;
  ...
  assign m_stg_6_rv$port1__read =
	     m_stg_6_rv$EN_port0__write ? 21'd699050 : m_stg_6_rv ;
  ...
  assign m_stg_6_rv$port2__read =
	     m_stg_6_rv$EN_port1__write ?
	       m_stg_6_rv$port1__write_1 :
	       m_stg_6_rv$port1__read ;
  assign m_stg_7_rv$port1__read = EN_response_get ? 21'd699050 : m_stg_7_rv ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        m_stg_0_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_1_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_2_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_3_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_4_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_5_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_6_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
	m_stg_7_rv <= `BSV_ASSIGNMENT_DELAY 21'd699050;
      end
    else
      begin
        if (m_stg_0_rv$EN)
